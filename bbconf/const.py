...
JSON_METADATA = ["genome", "exp_protocol", "cell_type", "antibody", "treatment",
                 "data_source"] \
...
JSON_NUMERIC_KEY_NAMES = [
    "JSON_GC_CONTENT_KEY", "JSON_REGIONS_NO_KEY", "JSON_MEAN_ABS_TSS_DIST_KEY",
...
JSON_KEYS = ["JSON_GC_CONTENT_KEY", "JSON_ID_KEY", "JSON_PLOTS_KEY",
             "JSON_MD5SUM_KEY"] + JSON_NUMERIC_KEY_NAMES + JSON_BEDSET_KEY_NAMES + JSON_METADATA
