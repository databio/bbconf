...
__all__ = ["BED_TABLE", "BEDSET_TABLE", "REL_TABLE",
           "CFG_ENV_VARS", "DB_DEFAULT_HOST", "SERVER_DEFAULT_PORT",
           "SERVER_DEFAULT_HOST", "PKG_NAME", "DEFAULT_SECTION_VALUES",
           "HIDDEN_ATTR_KEYS", "REL_BED_ID_KEY", "REL_BEDSET_ID_KEY",
           "BED_TABLE_SCHEMA", "BEDSET_TABLE_SCHEMA"] + CFG_KEYS
