...
JSON_BEDSET_KEY_NAMES = [
    "JSON_BEDSET_MEANS_KEY", "JSON_BEDSET_SD_KEY", "JSON_BEDSET_TAR_PATH_KEY",
    "JSON_BEDSET_BEDFILES_GD_STATS_KEY", "JSON_BEDSET_IGD_DB_KEY",
    "JSON_BEDSET_GD_STATS_KEY", "JSON_BEDSET_PEP_KEY"]
...
BED_COL_NAMES = ["id"] + BED_CHAR_COLS + BED_FLOAT_COLS + BED_INT_COLS + BED_JSONB_COLS
...
BEDSET_JSONB_COLS = [JSON_PLOTS_KEY, JSON_BEDSET_MEANS_KEY, JSON_BEDSET_SD_KEY]

BEDSET_NONNULL_COLS = [JSON_NAME_KEY, JSON_MD5SUM_KEY]
BEDSET_UNIQUE_COLS = [JSON_MD5SUM_KEY]

BEDSET_COL_NAMES = ["id"] + BEDSET_CHAR_COLS + BEDSET_JSONB_COLS
