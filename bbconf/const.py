...
JSON_DICTS_KEY_DESCS = {
    JSON_GC_CONTENT_KEY: "GC content", JSON_NAME_KEY: "BED file ID",
...
FLOAT_COLS = [JSON_MEAN_ABS_TSS_DIST_KEY, JSON_GC_CONTENT_KEY, JSON_MEAN_REGION_WIDTH]
INT_COLS = [JSON_REGIONS_NO_KEY]
NONNULL_COLS = [JSON_NAME_KEY, JSON_MD5SUM_KEY, BEDFILE_PATH_KEY]
CHAR_COLS = [JSON_MD5SUM_KEY, BEDFILE_PATH_KEY]

chars = [COL_CHAR.format(c) if c in NONNULL_COLS else
         COL_CHAR.format(c) + "NOT NULL" for c in CHAR_COLS]
floats = [COL_FLOAT.format(c) if c in NONNULL_COLS else
...
BED_COLUMNS = chars + floats + ints

__all__ = ["BED_TABLE", "BEDSET_TABLE", "REL_TABLE", "RAW_BEDFILE_KEY", "CFG_ENV_VARS",
           ...
           "HIDDEN_ATTR_KEYS", "BED_COLUMNS"] + CFG_KEYS + JSON_KEYS
