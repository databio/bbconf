...
BEDSET_CHAR_COLS = [JSON_MD5SUM_KEY, BEDFILE_PATH_KEY, JSON_NAME_KEY, JSON_BEDSET_TAR_PATH_KEY, JSON_BEDSET_BEDFILES_GD_STATS_KEY, JSON_BEDSET_GD_STATS_KEY, JSON_BEDSET_IGD_DB_KEY, JSON_BEDSET_PEP_KEY]
